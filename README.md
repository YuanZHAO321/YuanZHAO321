...
*读兵书，玩玄学，写代码。*<br/>
*Strategist temperament, builder's hands.*

<br/>

<!-- ═══════════ NAV ═══════════ -->

<sub>`root@yz321:~#` **ls /sections**</sub><br/>
<sub>[〇 档案](#dossier) ┃ [壹 藏书阁](#skills) ┃ [贰 武库](#arsenal) ┃ [叁 装备](#loadout) ┃ [肆 战报](#stats) ┃ [伍 三癖](#obsessions) ┃ [陆 信道](#comms)</sub>
...
```text
$ cat /classified/dossier_YZ321.txt                [ 密级：公开阅览 ]
═══════════════════════════════════════════════════════════════════

  代号      YZ-321
  本名      赵元 · Yuan Zhao
  轨迹      上海 → 吉隆坡 → 曼彻斯特
  现驻      University of Manchester · 留学生
  战功      Year 1 · First Class Honours

  倾向      军事史（重度）· 神秘学（分析向，不迷信）· 黑客（建设性）
  特征      把 LLM 塞进各种不该塞的地方；
            引经据典前必查原文，绝不凭记忆背书
  威胁评估  对屎山代码与加班文化持公开敌对立场（檄文已备，见藏书阁）
...
> ***为往圣继绝学，为 LLM 开新篇。***<br>
> *Claude skills distilled from reading the classics cover to cover — cite first, answer second. Not model memory.*

```text
经 · 史 · 子 · 集  ──►  SKILL.md
20+ 部典籍全文通读 · 引必查原文 · 查证优先于记忆 · 按四部分类法编目
```
...
| Skill | 底本与一句话 |
|---|---|
| 🕊 **[Poetic-Diplomacy](https://github.com/YuanZHAO321/Poetic-Diplomacy)** | `左传 · 诗经 · 尚书` 复原春秋"赋诗言志"的外交艺术——拟赋、解赋、演礼、评赋、辞命。83 处赋诗记录、126 处引诗，逐条收录 |
| 🎎 **[ZhouLi](https://github.com/YuanZHAO321/ZhouLi)** | `周礼 · 仪礼 · 礼记` 三礼知识体系，约 25 万字三轮通读——官制、仪节、服制、义理，先查证再作答 |

#### 📙 史部

| Skill | 底本与一句话 |
|---|---|
| 🏛 **[Chinese-History](https://github.com/YuanZHAO321/Chinese-History)** | `史记 · 资治通鉴` 两司马之镜：史记之镜察人，通鉴之镜审时——"太史公曰"论人、"臣光曰"论事，双笔合断 |

#### 📕 子部

| Skill | 家数 | 一句话 |
|---|---|---|
| ♟ **[strategist-mind](https://github.com/YuanZHAO321/strategist-mind)** | `兵家` | 枭雄理性主义谋略分析：破除迷障 → 盘点筹码 → 换位推演 → 权衡取舍 → 谋定后动，五思维原型多席推演 |
| 🧩 **[Logic](https://github.com/YuanZHAO321/Logic)** | `名家` | 论证四层模型：词项 → 命题 → 推理 → 解释，层层质检 + 谬误横向筛查；分析与构造双工作流 |
| 💬 **[Reasoning](https://github.com/YuanZHAO321/Reasoning)** | `西来辩者` | 苏格拉底辩证推理：定义立与破、把对手论证强化到最强再回应、思想实验、多路验证、假设债务记账 |
| 🌿 **[TCM.skill](https://github.com/YuanZHAO321/TCM.skill)** | `医家` | 家庭中医参谋 v3.0：十六部著作三层知识库（教材为用、古籍为源），安全表硬约束，A/B/C 分级建议 |
| 🌙 **[tarot-waite.skill](https://github.com/YuanZHAO321/tarot-waite.skill)** | `术数` | 韦特塔罗解读能力——由真实手稿转化，不是牌意数据库 |

#### 📘 集部

| Skill | 一句话 |
|---|---|
| ⚔️ **[XiWen](https://github.com/YuanZHAO321/XiWen)** | `五篇历史名檄` 奉辞伐罪之文：严肃仿古讨历史人物，现代戏仿讨屎山代码与加班文化 |
...
| 🛡 **[WechatRevokeCountermeasure](https://github.com/YuanZHAO321/WechatRevokeCountermeasure)** | Windows 微信防撤回：注册表定位 + DLL 特征码补丁，覆盖 2.7 → 4.1.x——电子对抗，反撤回作战 |
...
<sub>*奇门遁甲 · 蛇行阵，逐格蚕食*</sub>

</div>

<!-- ══════════════════ 伍 三癖 ══════════════════ -->

<div align="center"><br/><sub>─────────── 结界 · ward line ─ 以下区域不设防，非战斗人员可自由通行 ───────────</sub><br/><br/></div>

<a id="obsessions"></a>
## 🎐 伍 · 三癖 · The Three Obsessions
...
🔮  神秘学
     analytical lens, not belief. 分析工具，不是信仰。
     奇门 · 玄空 · 八字 · 塔罗——喜欢到全都写成了代码（见武库与藏书阁）。
     世界的运作方式有很多种描述。

💻  黑客
     建设性的那种。constructive, mostly.
     local LLMs · cloned voices · self-hosted VPN · DLL 特征码补丁
     经常部署一些不该跑在笔记本上的东西。
```
